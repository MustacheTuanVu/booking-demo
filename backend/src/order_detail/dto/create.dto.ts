...
class ComboInfo {
  ...
  @ApiProperty({ description: 'combo id', type: String, required: false })
  @IsOptional()
  @IsNumber()
  count: number;
}
...
export class CreateOrderDetail {
  ...
  @ApiProperty({
    description: 'Item upsell (array of item IDs)',
    type: () => [ComboItem],
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({ description: 'J seat number', type: Number, required: false })
  @IsOptional()
  @IsNumber()
  @Min(0)
  j_size?: number;

  @ApiProperty({ description: 'Q seat number', type: Number, required: false })
  @IsOptional()
  @IsNumber()
  @Min(0)
  q_size?: number;

  @ApiProperty({ description: 'K seat number', type: Number, required: false })
  @IsOptional()
  @IsNumber()
  @Min(0)
  k_size?: number;
